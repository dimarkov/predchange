...
"""
Here we simulate behavior of the four behavioral models IRI, RRI, DU-RW, and 
SU-RW in two environments (one with irregular between reversal intervals and 
another with regular between reversal intervals) over 160 trials.  
"""
